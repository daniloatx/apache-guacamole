...
echo
echo
echo "INSTALACAO DO APACHE GUACAMOLE - VERSAO 1.3.0"
echo
echo
...
cp -v guacamole-1.3.0.war /etc/guacamole/guacamole.war
...
cp -v mysql/guacamole-auth-jdbc-mysql-1.3.0.jar /etc/guacamole/extensions/
